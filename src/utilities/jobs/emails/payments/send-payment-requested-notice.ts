...
const sendPaymentRequestedNotice = async ({
  ...
  await sendEmail({
    ...
    html: `
      ...
      <p>
        Please click the following link to decline if this is a mistake: <a href="${process.env.APP_URL}/reject-payment/${cancelToken}?paymentId=${paymentId}">Decline Payment Request</a>.
      </p>
    `,
  });
