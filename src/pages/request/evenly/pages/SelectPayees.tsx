...
import { Page, RequestContext } from "@/contexts/request/requestEvenlyContext";
import { ActionType } from "@/contexts/request/requestEvenlyContext";
...
const SelectPayees = () => {
  ...
  const onClickPayees = async (user: User) => {
    await dispatch({ type: ActionType.CHANGE_PAYEE_SELECTION, payload: user });
  };
